...
mod store_type;
use store_type::{
	convert_to_proof_store, convert_to_verification_key, ProofStore, VerificationKey,
};
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		#[pallet::call_index(0)]
		#[pallet::weight(70000)]
		pub fn create_ptrade_proof(origin: OriginFor<T>, id: u32, account: u128) -> DispatchResult {
		...
		#[pallet::call_index(1)]
		#[pallet::weight(50000)]
		pub fn create_random(origin: OriginFor<T>) -> DispatchResult {
		...
		#[pallet::call_index(2)]
		#[pallet::weight(50000)]
		pub fn verification_proof(origin: OriginFor<T>, id: u32) -> DispatchResult {
		...
		#[pallet::call_index(3)]
		#[pallet::weight(70000)]
		pub fn create_transcation_proof(origin: OriginFor<T>, id: u32, trade_self: u32, trade_object: u32) -> DispatchResult {
		...
		#[pallet::call_index(4)]
		#[pallet::weight(70000)]
		pub fn create_store_proof(origin: OriginFor<T>, id: u32) -> DispatchResult {
			log::info!("create_proof_start");
			let mut rng = pallet_randrng::create_rng::<T>();
		...
		#[pallet::call_index(5)]
		#[pallet::weight(30000)]
		pub fn lock_volume(origin: OriginFor<T>, id: u32,volume: u128) -> DispatchResult {
			LockVolume::<T>::insert(id,volume);
			Ok(())
		}
		#[pallet::call_index(6)]
		#[pallet::weight(40000)]
		pub fn have_a_trade(origin: OriginFor<T>, id: u32) -> DispatchResult {
